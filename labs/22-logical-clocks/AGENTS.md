...
```
src/lab_22_logical_clocks/    the package
...
- Pendulum is confined to explicit-offset parsing and operator timezone
  display. Deadlines remain monotonic and causal decisions remain logical.
