...
```
src/lab_30_dag_engine/    the package
tests/                the test suite
```

## Relay checkpoint

This lab is checkpoint 29 of one relay product. Keep the relay DAG node ids
stable so the next Airflow checkpoint can mirror them.
