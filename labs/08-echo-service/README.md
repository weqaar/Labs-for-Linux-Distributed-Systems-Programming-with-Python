...
Relay checkpoint eight swaps the scaffold out for a real TCP byte stream on
loopback.
...
This checkpoint keeps the payload textual and concentrates on the transport.
...
```
src/lab_08_echo_service/    the package
