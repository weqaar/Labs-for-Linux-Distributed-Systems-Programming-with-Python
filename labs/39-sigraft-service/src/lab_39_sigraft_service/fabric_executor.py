"""A Fabric-style verification task that checks every deployed SigRaft host."""
...
@dataclass
class HttpHostProbe:
    """Verify SigRaft hosts by reading their health and metadata endpoints."""
...
def main(argv: list[str] | None = None) -> int:  # pragma: no cover
    parser = argparse.ArgumentParser(description="Verify SigRaft hosts after deploy")
