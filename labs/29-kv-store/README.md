...
Checkpoint 29 of the relay product. This lab keeps the same relay task contract
...
Inspect one key and versioned value before performing a conditional write.
Distinguish a missing key from a stored null-like value.
