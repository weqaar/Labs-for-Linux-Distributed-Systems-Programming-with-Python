...
```
src/lab_20_replicated_log/    the package
...
- Keep replication deterministic. Model crashes, restarts and commit boundaries
  as explicit state transitions rather than timing sleeps.
