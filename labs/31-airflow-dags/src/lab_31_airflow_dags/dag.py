...
def build_relay_dag() -> DagDefinition:
    ...
    tasks = (
        DagTaskSpec(
            ...
            kind="sensor",
            deferrable=True,
            callable_name="lab_31_airflow_dags.runtime.wait_for_partition_snapshot",
        ...
        DagTaskSpec(
            ...
            callable_name="lab_31_airflow_dags.runtime.discover_pending_tasks",
        ),
        DagTaskSpec(
            ...
            callable_name="lab_31_airflow_dags.runtime.hydrate_task_context",
        ),
        DagTaskSpec(
            ...
            dynamic_map_from="discover-pending-tasks",
            callable_name="lab_31_airflow_dags.runtime.run_relay_task",
        ...
        DagTaskSpec(
            ...
            callable_name="lab_31_airflow_dags.runtime.persist_task_status",
        ),
        DagTaskSpec(
            ...
            callable_name="lab_31_airflow_dags.runtime.publish_run_metrics",
        ),
    )
