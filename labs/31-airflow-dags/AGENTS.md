...
```
src/lab_31_airflow_dags/    the package
tests/                the test suite
```

## Relay checkpoint

This lab is checkpoint 30 of one relay product. Keep the relay DAG node ids
aligned with Lab 30, and keep the module importable without Airflow or network
access.
